...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        # Check if classifier label is a dog (can be multiple, separated by commas)
        classifier_labels = [x.strip().lower() for x in results_dic[key][1].split(",")]
        is_classifier_dog = 0
        ...
        # Extend the list with the results
